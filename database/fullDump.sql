...
CREATE TABLE IF NOT EXISTS `wasps`.`Ride` (
  ...
  `status` ENUM('Unverified', 'Pending', 'Scheduled', 'Complete', 'Canceled') NOT NULL,
...
START TRANSACTION;
USE `wasps`;
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (1, 4, 3, '2018-04-23 09:00:00', '2018-04-23 10:00:00', NULL, NULL, '2018-04-23 08:30:00', false, 'Scheduled', '855 publishers parkway', 'Webster', '45 Webster Commons Blvd #201', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (2, 4, 3, '2018-04-25 09:00:00', '2018-04-25 10:00:00', NULL, NULL, '2018-04-25 08:30:00', false, 'Pending', '746 Newberry Ln', 'Webster', '55 North Ave B', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (3, 4, NULL, '2018-04-24 09:00:00', '2018-04-24 10:00:00', NULL, NULL, '2018-04-24 08:30:00', false, 'Unverified', '746 Newberry Ln', 'Webster', '55 North Ave B', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (4, 4, 3, '2018-04-27 09:00:00', '2018-04-27 10:00:00', 7, 120, '2018-04-27 08:30:00', false, 'Complete', '855 publishers parkway', 'Webster', '45 Webster Commons Blvd #201', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (5, 4, 5, '2018-04-22 09:00:00', '2018-04-22 10:00:00', NULL, NULL, '2018-04-22 08:30:00', false, 'Scheduled', '746 Newberry Ln', 'Webster', '55 North Ave B', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (6, 4, 5, '2018-04-22 09:00:00', '2018-04-22 10:00:00', NULL, NULL, '2018-04-22 08:30:00', false, 'Canceled', '855 publishers parkway', 'Webster', '45 Webster Commons Blvd #201', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (7, 4, NULL, '2018-04-22 11:00:00', '2018-04-22 11:30:00', NULL, NULL, '2018-04-22 10:30:00', false, 'Unverified', '746 Newberry Ln', 'Webster', '55 North Ave B', 'Webster', '2018-02-01 08:00:00');
INSERT INTO `wasps`.`Ride` (`id`, `userID`, `driverID`, `apptStart`, `apptEnd`, `numMiles`, `totalMinutes`, `pickupTime`, `wheelchairVan`, `status`, `pickupStreetAddress`, `pickupCity`, `apptStreetAddress`, `apptCity`, `timestamp`) VALUES (8, 4, 7, '2018-04-20 09:00:00', '2018-04-20 10:00:00', NULL, NULL, '2018-04-20 08:30:00', false, 'Unverified', '855 publishers parkway', 'Webster', '45 Webster Commons Blvd #201', 'Webster', '2018-02-01 08:00:00');
...
START TRANSACTION;
USE `wasps`;
INSERT INTO `wasps`.`Comments` (`id`, `comment`, `timestamp`, `userID`, `rideID`) VALUES (1, 'This is a comment by admin on ride 1', '2018-02-01 08:01:00', 1, 1);
INSERT INTO `wasps`.`Comments` (`id`, `comment`, `timestamp`, `userID`, `rideID`) VALUES (2, 'This is a comment by dispatcher on ride 1', '2018-02-01 08:02:00', 2, 1);
INSERT INTO `wasps`.`Comments` (`id`, `comment`, `timestamp`, `userID`, `rideID`) VALUES (3, 'This is a comment by admin on ride 3', '2018-02-01 08:03:00', 1, 3);
