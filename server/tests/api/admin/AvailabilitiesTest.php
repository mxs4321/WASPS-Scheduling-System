...
class AdminAvailabilitiesTest extends TestCase
{
    private $http;
    private $cookieJar;
    ...
    public function testCreatingDriverAvailabilityForDriverID()
    {
        $response = $this->http->request('POST', '/api/driverAvailabilities.php?driverID=3', [
            'json' => [
                'start' => '07:00:00',
                'end' => '16:00:00',
                'days' => 'Mon,Tue,Wed,Thu,Fri',
    ...
    public function testUpdateDriverAvailabilityForDriverID()
    {
